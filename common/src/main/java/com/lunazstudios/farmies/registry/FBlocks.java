...
public class FBlocks {
    ...
    public static final Supplier<Block> EGGPLANTS = registerBlockOnly("eggplants", () -> new EggplantCropBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHEAT)));
    public static final Supplier<Block> STRAWBERRIES = registerBlockOnly("strawberries", () -> new StrawberryCropBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.WHEAT)));
